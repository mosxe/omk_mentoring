                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td
                      className={`${styles['competences__table_border-b']} ${styles['competences__table_border-t']} ${styles['competences__table_padding-a']}`}
                    >
                      Лично показывает, как надо выполнять работу, отвечает на
                      все вопросы
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>3.1.</td>
                    <td>
                      Сотрудник вкладывает свое время в развитие другого
                      человека (несет ответственность за качество работы как
                      наставник, прилагает дополнительные усилия для достижения
                      результата)
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td rowSpan={3}>
                      <div className={styles.competences__table_row}>
                        ...
                        Приверженность (лояльное отношение к Компании и
                        соблюдение правил)
                      </div>
                    </td>
                    <td className={styles['competences__table_border-b']}>
